...
type PaymentState = 'form' | 'processing' | 'success' | 'cancelled' | 'error';
...
export default function BookingModal({
  ...
  const basePrice = farm.pricePerNight * nights;
  const extraGuestCharge = Math.max(0, guests - 2) * 500 * nights; // ₹500 per extra guest per night
