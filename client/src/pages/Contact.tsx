                    ...
                    <CardContent className="p-6">
                      <div className="flex items-start space-x-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-neutral-600 mb-2">{info.description}</p>
                          {info.details.map((detail, idx) => (
                            <p key={idx} className="text-neutral-800 font-medium">
                              {detail}
                            </p>
                          ))}
                        </div>
            ...
            {[
              {
                ...
                answer: 'Simply browse our properties, select your dates, and click "Book Now" to start the reservation process.'
              },
              {
                question: 'What is included in the price?',
                answer: 'All our properties include basic amenities, maintenance, and 24/7 support. Additional services may vary by property.'
              },
              {
                question: 'Can I cancel my booking?',
                answer: 'Yes, cancellation policies vary by property. Please check the specific cancellation terms during booking.'
              },
              {
                question: 'Are pets allowed?',
                answer: 'Pet policies vary by property. Look for the "Pet Friendly" tag or contact us for specific requirements.'
              }
            ].map((faq, index) => (
              <Card key={index}>
                <CardContent className="p-6">
