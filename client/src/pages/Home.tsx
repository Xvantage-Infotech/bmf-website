        ...
        <div className="max-w-7xl mx-auto container-padding section-padding relative z-10">
          ...
          <div className="text-center mb-16 pt-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8 leading-relaxed">
              Discover handpicked farmhouses nestled in nature's embrace. From cozy cottages to luxury villas, 
              find your perfect retreat for unforgettable memories.
            </p>
        ...
        <div className="max-w-4xl mx-auto text-center container-padding relative z-10">
          <div className="bg-white/60 backdrop-blur-sm rounded-3xl p-12 border border-white/20 shadow-xl">
            ...
            <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
              Join thousands of property owners who are earning extra income by hosting guests at their beautiful farmhouses and villas.
            </p>
