        ...
        <div className="space-y-6">
          ...
          <div className="pt-4">
            <Button
              ...
              className="w-full h-16 bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary/70 text-white font-semibold text-base sm:text-lg md:text-xl rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-[1.02] whitespace-normal text-center flex items-center justify-center gap-2"
              size="lg"
            >
              <Search className="w-5 h-5 shrink-0" />
              <span>Search Amazing Farmhouses</span>
            </Button>
          </div>
