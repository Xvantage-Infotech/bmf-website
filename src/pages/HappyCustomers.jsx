      ...
      <section className="bg-gradient-to-br from-primary/5 to-primary/10 section-padding">
        <div className="max-w-7xl mx-auto container-padding text-center">
          ...
          <p className="text-lg text-neutral-600 max-w-2xl mx-auto mb-8">
            Discover what our guests are saying about their memorable experiences at our premium farmhouses
          </p>
      ...
      <section className="section-padding">
        <div className="max-w-7xl mx-auto container-padding">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-neutral-900 mb-4">Guest Reviews</h2>
            <p className="text-lg text-neutral-600">Real experiences from real guests</p>
          </div>
      ...
      <section className="section-padding bg-primary/5">
        <div className="max-w-4xl mx-auto text-center container-padding">
          ...
          <p className="text-lg text-neutral-600 mb-8">
            Join thousands of satisfied guests who have experienced the magic of our farmhouses
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="/" className="bg-primary text-white px-8 py-3 rounded-lg font-medium hover:bg-primary/90 transition-colors">
              Browse Properties
            </a>
            <a href="/contact" className="border border-neutral-300 text-neutral-700 px-8 py-3 rounded-lg font-medium hover:bg-neutral-50 transition-colors">
              Contact Us
            </a>
          </div>
        </div>
