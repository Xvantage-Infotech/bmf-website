  ...
  return (
    <div className="max-w-md mx-auto py-10 px-4">
      <div className="flex flex-col items-center bg-white rounded-2xl shadow p-6 mb-8 relative">
        ...
        <p className="text-neutral-600 mb-2">{user?.location || 'No location set'}</p>
        <div className="w-full text-left space-y-2 mt-4">
          <div><span className="font-medium">Phone:</span> {user?.mobileNumber || 'Not provided'}</div>
          <div><span className="font-medium">DOB:</span> {user?.dob || 'Not provided'}</div>
